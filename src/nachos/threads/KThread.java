...
public class KThread {
	...
	public static void finish() {
		...
		if(currentThread.FatherThread!=null)
			currentThread.FatherThread.nextThread().ready();
	...
	public void join() {
		...
		Lib.assertTrue(numOfJoin==0,"join is called twice");
		
		boolean flag=Machine.interrupt().disable();
		FatherThread=ThreadedKernel.scheduler.newThreadQueue(true);
		if(status!=statusFinished)
		{		
			FatherThread.acquire(this);
			FatherThread.waitForAccess(currentThread);
			sleep();
		}
	...
	public int numOfJoin=0;
	ThreadQueue FatherThread=null;
