...
public class StubFileSystem implements FileSystem {
	...
	private boolean usingRealFilesystem() {
		if (usingRealFilesystem ==null)
			usingRealFilesystem = (ThreadedKernel.fileSystem instanceof RealFileSystem);
		return usingRealFilesystem;
	}
	...
	private static Boolean usingRealFilesystem;
