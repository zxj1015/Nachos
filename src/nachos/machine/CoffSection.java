...
public class CoffSection {
	...
	//	debug.print("spn: "+spn+" "+"ppn:"+ppn+" numPages:"+numPages);
		...
		if (!initialized)
			...
			/**
			 * initlen = size % pageSize; <br>
			 * Bug identified by Steven Schlansker 3/20/08<br>
			 * Bug fix by Michael Rauser
			 */
			/**
			 * initlen = (size == pageSize) ? pageSize : (size % pageSize);<br>
			 * Bug identified by Xiangru Chen, Dec. 25th, 2008<br>
			 * Bug fix by Xiangru Chen, Sep. 14th, 2009
			 */
